...
(function (window, document) {
    ...
    var STRINGS = {
        en: {
            ...
            groupPresenter: 'For the presenter',
            actionGoDealer: 'The showroom tablet, in a new tab',
            actionGoVerify: 'Dengage row counts, in a new tab',
            ...
            drawnHere: 'Nissan creative, drawn by this demo',
            alsoExitIntent: 'Nissan creative, also on exit intent',
            alsoScrollDepth: 'Nissan creative, also on scroll',
        ...
        ar: {
            ...
            drawnHere: 'محتوى نيسان معروض من هذا العرض التوضيحي',
            alsoExitIntent: 'محتوى نيسان، ويظهر أيضاً عند نية المغادرة',
            alsoScrollDepth: 'محتوى نيسان، ويظهر أيضاً عند التمرير',
            setupNote: 'كل ما يُلتقط يصل إلى دنجيج عبر الأحداث والمُرحّل المعتادين',
            quickRef: 'مرجع سريع',
